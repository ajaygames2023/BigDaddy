...
import 'chips_purchage.dart';
import 'widgets/kyc_details.dart';
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            ExpansionTile(
              ...
              title: const CasinoText(text: 'KYC Section',align: TextAlign.start,fontWeight: FontWeight.bold,),
              collapsedBackgroundColor: CasinoColors.primary,
              children: [
                DottedBorder(
                  color: CasinoColors.primary,
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: KycDetails(controller: controller,),
                  ),
                )
              ],),
            ...
            Padding(
              ...
              child:Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  PersonaldetailChip(controller: controller,),
                  const SizedBox(width: 20,),
                  Expanded(child: ChipsPurchage(controller: controller,)),
                ],
              ),
            ),
            ...
            //         ),
            //         const SizedBox(width: 20,),
            //         if(controller.isNameField) GestureDetector(
            ...
            //                       children: [
            //                         SizedBox(
            //                           child: (controller.signatureImg != null ) ? Image.memory(controller.signatureImg!) : const SizedBox.shrink(),
            //                         ),
            //                         const Align(
            //                           alignment: Alignment.bottomCenter,
            //                           child: CasinoText(text: 'Add signature',fontSize: 10,),
            //                         )
            //                       ],
            //                     ),
            //                   )
